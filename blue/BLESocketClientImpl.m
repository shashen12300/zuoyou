...
- (id)init:(NSString*)sUUID notifyCharacteristicUUID:(NSString*)notifyUUID writeCharacteristicUUID:(NSString*)writeUUID
{
    ...
    if (self) {
       ...
       self.mPeripheralArray = [[NSMutableArray alloc] init];
    }
    return self;
}
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI
{
    ...
    if (![self.mPeripheralArray containsObject:peripheral]) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:MESSAGEFORLIST object:self userInfo:nil];
    }
    
    
   // [self.mPeripheralArray removeObject:peripheral];
//    if([peripheral.name hasPrefix:@"ZuoYou"]){
//        
...
- (void)centralManager:(CBCentralManager *)central didFailToConnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    UIAlertView *alert=[[UIAlertView alloc] initWithTitle:@"提示" message:log delegate:self cancelButtonTitle:@"关闭" otherButtonTitles:nil];
    [alert show];
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    // @synchronized(_discoveredPeripheral){

...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(setImageWithStrength) name:@"frequenceViewDataReceivedNotification" object:nil];
...
-(void)setImageWithStrength//用来接收一下通知
{
    ...
    NSString *str = [ NSString stringWithFormat:@"strength%ld",(long)[StaticValueClass getFrequencyView]];
